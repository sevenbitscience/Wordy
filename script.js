    ...
    if (wrds.includes(word)) {
        ...
        for (const letter of word_chars) {
            if (ans_chars.includes(letter)) {
                if (word_chars.indexOf(letter) == ans_chars.indexOf(letter)) {
